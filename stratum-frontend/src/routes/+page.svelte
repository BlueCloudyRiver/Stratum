...
>
	...
	<nav class="relative z-10 border-b border-white/10 bg-black/40 backdrop-blur-md">
		<div class="max-w-7xl mx-auto h-16 px-6 flex items-center justify-between">
			<div class="flex items-center gap-3">
				<div class="w-6 h-6 bg-contain bg-center bg-no-repeat"
     style="background-image: url('{stratum}');">
</div>


				<span class="text-white font-bold text-xs tracking-widest uppercase font-sans">Stratum</span>
			</div>
	...
	<main class="relative z-10 max-w-7xl mx-auto px-6 pt-16 pb-24 grid lg:grid-cols-12 gap-8 items-center min-h-[calc(screen-64px)]">
